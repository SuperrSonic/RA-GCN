...
static void init_video_input(void)
{
   ...
   video.wide_correction = g_settings.video.wide_correction;
   video.correct_amount = g_settings.video.correct_amount;
   video.wide_viwidth = g_settings.video.wide_viwidth;
   ...
   video.wide_smooth = g_settings.video.wide_smooth;
