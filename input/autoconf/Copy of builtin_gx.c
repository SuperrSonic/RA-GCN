...
/* L/R should not be forced, instead made default by config.def
 *
 * DECL_BTN(l, 6) \
 * DECL_BTN(r, 7) \
*/
...
// hmm, we don't need to map these
/* DECL_BTN(l, 54) \
DECL_BTN(r, 55) \
*/
...
#ifdef HW_RVL
   DECL_AUTOCONF_DEVICE("Wii Remote", "gx", GXINPUT_WIIMOTE_DEFAULT_BINDS),
   DECL_AUTOCONF_DEVICE("Nunchuk Extension", "gx", GXINPUT_NUNCHUK_DEFAULT_BINDS),
