...
#include "../input/ds/network.c"
#include "../input/ds/3ds.c"
#endif
#endif
...
#include "../gfx/filters/normal2x_height.c"
#include "../gfx/filters/normal2x_width.c"
#include "../gfx/filters/dot_matrix_3x.c"
#include "../gfx/filters/gameboy3x.c"
