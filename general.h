...
struct settings
{
   struct 
   {
	  ...
	  bool autores;
	  bool force_288p;
	  bool wide_correction;
	  unsigned correct_amount;
	  unsigned wide_viwidth;
   ...
   struct
   {
	  ...
	  unsigned n3ds_r;
	  unsigned n3ds_start;
	  unsigned n3ds_select;
	  unsigned n3ds_up;
	  unsigned n3ds_down;
	  unsigned n3ds_left;
	  unsigned n3ds_right;
	  unsigned n3ds_stick_up;
	  unsigned n3ds_stick_down;
	  unsigned n3ds_stick_left;
	  unsigned n3ds_stick_right;
  ...
  // char cheat_settings_path[PATH_MAX];
   ...
   bool exit_fade;
   //particle effects
   unsigned particle_type;
   float particle_speed;
   unsigned particle_clr;
