      ...
      void *userdata)
{
   ...
   palette[0] = GAMEBOY_3X_DEFAULT_PALETTE_0;
   palette[1] = GAMEBOY_3X_DEFAULT_PALETTE_1;
   palette[2] = GAMEBOY_3X_DEFAULT_PALETTE_2;
   palette[3] = GAMEBOY_3X_DEFAULT_PALETTE_3;
   palette_grid = GAMEBOY_3X_DEFAULT_PALETTE_GRID;
#if 0
